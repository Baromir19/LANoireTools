...
parser.add_argument('--outdirectory', default='', help='The path to save the output files.')
...
outdirectory = args.outdirectory if args.outdirectory else directory
